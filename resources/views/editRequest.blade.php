						...
						<div class="col-12 col-lg-12 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h3 class="">Edit Plasma Requests Details</h3>
                                    <div class="text-end"><a href="/requestsList"><button class="btn btn-danger"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Back</button></a></div>
								</div>
                                <div class="card-body">
                                    <form action="{{url('updateRequest/'.$plasma->id)}}"  method="post" class="p-5 border border-2 rounded"> 
                                        @csrf
                                        @method('PATCH')
                                        <div class="form-group mb-3">
                                            <label for="name" class="form-label fw-bold">Name<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" value="{{$plasma->rname}}" name="rname" id="name" placeholder="Your Name">
                                            @if ($errors->has('rname'))
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control" onblur="myFunction()" name="age" value="{{$plasma->age}}" id="age" placeholder="Your Age">
                                            @if ($errors->has('age'))
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control" value="{{$plasma->positive_date}}" name="positive_date" id="pdate">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control" value="{{$plasma->negative_date}}" name="negative_date" id="ndate">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select  id="state-dd" name="state_id" class="form-control">
                                                ...
                                                <option value="{{$plasma->state_id}}" selected>{{$plasma->sname}}</option>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select id="city" class="form-control" name="city_id">
                                                ...
                                                <option value="{{$plasma->city_id}}" selected>{{$plasma->cname}}</option>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control" value="{{$plasma->phone}}" name="phone" id="phone" placeholder="Your Phone Number">
                                            @if ($errors->has('phone'))
