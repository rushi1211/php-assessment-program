						...
						<div class="col-12 col-lg-12 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h3 class="">Add Plasma Request Details</h3>
                                    <div class="text-end"><a href="requestsList"><button class="btn btn-danger"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                                    Back</button></a></div>
								</div>
                                <div class="card-body">
                                    <form action="saveRequest"  method="post" class="p-5 border border-2 rounded"> 
                                        @csrf
                                        <div class="form-group mb-3">
                                            <label for="name" class="form-label fw-bold">Name<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="rname" id="name" placeholder="Your Name">
                                            @if ($errors->has('rname'))
